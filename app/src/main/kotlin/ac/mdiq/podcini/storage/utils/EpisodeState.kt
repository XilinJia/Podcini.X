...
enum class EpisodeState(val code: Int, val res: Int, val color: Color?, val userSet: Boolean) {
    ...
    LATER(1, R.drawable.baseline_watch_later_24, Color.Blue, true),
    SOON(2, R.drawable.baseline_access_alarms_24, Color.Blue, true),
    QUEUE(3, R.drawable.ic_playlist_play, Color.Green, true),
    PROGRESS(5, R.drawable.baseline_play_circle_outline_24, Color.Yellow, false),
