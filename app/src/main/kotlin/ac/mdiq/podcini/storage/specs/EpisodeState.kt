...
enum class EpisodeState(val code: Int, val res: Int, val color: Color?, val userSet: Boolean) {
    ...
    ERROR(-5, R.drawable.ic_error, Color.Companion.Red, false),
    BUILDING(-2, R.drawable.baseline_build_24, null, false),
    NEW(-1, R.drawable.outline_new_releases_24, Color.Companion.Magenta, false),
    UNPLAYED(0, R.drawable.baseline_new_label_24, null, true),
    LATER(1, R.drawable.baseline_watch_later_24, Color.Companion.Blue, true),
    SOON(2, R.drawable.baseline_access_alarms_24, Color.Companion.Blue, true),
    QUEUE(3, R.drawable.ic_playlist_play, Color.Companion.Green, true),
    PROGRESS(5, R.drawable.baseline_play_circle_outline_24, Color.Companion.Yellow, false),
    AGAIN(7, R.drawable.baseline_replay_24, Color.Companion.Cyan, true),   // was 12
    FOREVER(8, R.drawable.baseline_light_mode_24, Color.Companion.Cyan, true),     // was 15
